...
def load_params(params_path: str) -> dict:
    ...
    try:
        ...
        logging.debug("Parameterss recieved from %s", params_path)
        return params
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        logging.error("Unexpected error during the datapreprocessing: %s", e)
        raise
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    ...
    try:
        ...
        logging.debug("Train and Test data saved tp %s", raw_data_path)
    except Exception as e:
